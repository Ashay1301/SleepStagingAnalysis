...
class TinySleepNet(object):
    ...
    def build_cnn(self):
        ...
        with tf.variable_scope("cnn") as scope:
            ...
            net = nn.conv1d("conv1d_2_4", net, 64, 8, 1)
            net = nn.batch_norm("bn_2_4", net, self.is_training)
            net = tf.nn.relu(net, name="relu_2_4")
            net = nn.conv1d("conv1d_2_5", net, 32, 8, 1)
            net = nn.batch_norm("bn_2_5", net, self.is_training)
            net = tf.nn.relu(net, name="relu_2_5")
