    ...
    for epoch in range(model.get_current_epoch(), config["n_epochs"]):
        ...
        for v in tf.trainable_variables():
            if 'cnn/conv1d_1/conv2d/kernel:0' in v.name:
                ...
                break
# =============================================================================
#                 train_acc_list.append(train_outs["train/accuracy"]*100)
#                 train_loss_list.append(train_outs["train/stream_metrics"]["loss"])
#                 val_acc_list.append( valid_outs["test/accuracy"]*100)
#                 val_loss_list.append(valid_outs["test/loss"])
#                 val_f1_list.append(valid_outs["test/f1_score"]*100)
#                 test_acc_list.append(test_outs["test/accuracy"]*100)
#                 test_f1_list.append(test_outs["test/f1_score"]*100)
#                 print("Simple print: train_acc", train_outs["train/accuracy"]*100)
#                 x = train_sids["train/accuracy"]*100
#                 print("x: ",x)
#                 y = summary.value("e_accuray/train")
#                 print("y: ",y)
# =============================================================================
...
# =============================================================================
        ...
        test_acc_list.append(test_outs["test/accuracy"]*100)
        test_f1_list.append(test_outs["test/f1_score"]*100)
        train_time_list.append(train_outs["train/duration"])
        test_time_list.append(test_outs["test/duration"])
        val_time_list.append(valid_outs["test/duration"])
        print("Train_acc", train_outs["train/accuracy"]*100)
        print("Train_loss", train_outs["train/stream_metrics"]["loss"])
        print("Val_acc", valid_outs["test/accuracy"]*100)
        print("Val_loss", valid_outs["test/loss"])
        print("Val_f1", valid_outs["test/f1_score"]*100)
        print("Test_acc", test_outs["test/accuracy"]*100)
        print("Test_f1", test_outs["test/f1_score"]*100)
        print("Train_time: ",train_outs["train/duration"])
        print("Test_time: ",test_outs["test/duration"])
        print("Val_time: ",valid_outs["test/duration"])
...
#         print("y: ",y)
# =============================================================================
        with open("Vis_data/train_data/train_acc_data.txt", "w") as f:
            for s in train_acc_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/train_loss_data.txt", "w") as f:
            for s in train_loss_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/val_acc_data.txt", "w") as f:
            for s in val_acc_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/val_loss_data.txt", "w") as f:
            for s in val_loss_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/val_f1_data.txt", "w") as f:
            for s in val_f1_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/test_acc_data.txt", "w") as f:
            for s in test_acc_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/test_f1_data.txt", "w") as f:
            for s in test_f1_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/val_time_data.txt", "w") as f:
            for s in val_time_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/train_time_data.txt", "w") as f:
            for s in train_time_list:
                f.write(str(s) +"\n")
        f.close()
        with open("Vis_data/train_data/test_time_data.txt", "w") as f:
            for s in test_time_list:
                f.write(str(s) +"\n")
        f.close()
